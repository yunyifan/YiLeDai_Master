...
//  RunTime使用案例
//
//  Created by 貟一凡 on 2018/5/30.
//  Copyright © 2018年 貟一凡. All rights reserved.
//
...
{
    if ([NSStringFromClass(self.class) isEqualToString:@"UIButton"] ||[NSStringFromClass(self.class) isEqualToString:@"FSCustomButton"]) {
