...
@property (nonatomic,strong)NSString *dueAmt; //应还本金
...
@property (nonatomic,strong)NSString *createTime; //应还日期
@property (nonatomic,strong)NSString *dueTerm; //应还期次


@property (nonatomic,strong)NSString *dueFee; //应还费用
@property (nonatomic,strong)NSString *repayAccno; //应还费用
@end
